...
/// struct for passing parameters to the method [`predictions_list`]
#[derive(Clone, Debug)]
pub struct PredictionsListParams {
    pub last_prediction_time__gt: Option<String>,
    pub last_prediction_time__lt: Option<String>,
    ...
    pub points_won: Option<f32>,
    pub points_won__gt: Option<f32>,
    pub points_won__gte: Option<f32>,
    pub points_won__lt: Option<f32>,
    pub points_won__lte: Option<f32>,
    pub question: Option<i32>,
    pub user: Option<i32>,
    pub username: Option<String>,
}

/// struct for passing parameters to the method [`predictions_retrieve`]
#[derive(Clone, Debug)]
pub struct PredictionsRetrieveParams {
    /// A unique integer value identifying this combo prediction.
    pub id: i32,
}

/// struct for typed errors of method [`predictions_list`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum PredictionsListError {
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method [`predictions_retrieve`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum PredictionsRetrieveError {
    UnknownValue(serde_json::Value),
}
...
pub async fn predictions_list(
...
) -> Result<crate::models::PaginatedPredictionUsernameList, Error<PredictionsListError>> {
    let local_var_configuration = configuration;

    // unbox the parameters
    let last_prediction_time__gt = params.last_prediction_time__gt;
    let last_prediction_time__lt = params.last_prediction_time__lt;
    let limit = params.limit;
    let offset = params.offset;
    let order_by = params.order_by;
    let points_won = params.points_won;
    let points_won__gt = params.points_won__gt;
    let points_won__gte = params.points_won__gte;
    let points_won__lt = params.points_won__lt;
    let points_won__lte = params.points_won__lte;
    ...
    let local_var_uri_str = format!("{}/api2/predictions/", local_var_configuration.base_path);
    let mut local_var_req_builder =
        local_var_client.request(reqwest::Method::GET, local_var_uri_str.as_str());

    if let Some(ref local_var_str) = last_prediction_time__gt {
        local_var_req_builder = local_var_req_builder
            .query(&[("last_prediction_time__gt", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_str) = last_prediction_time__lt {
        local_var_req_builder = local_var_req_builder
            .query(&[("last_prediction_time__lt", &local_var_str.to_string())]);
    }
    ...
    if let Some(ref local_var_str) = points_won {
        local_var_req_builder =
            local_var_req_builder.query(&[("points_won", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_str) = points_won__gt {
        local_var_req_builder =
            local_var_req_builder.query(&[("points_won__gt", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_str) = points_won__gte {
        local_var_req_builder =
            local_var_req_builder.query(&[("points_won__gte", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_str) = points_won__lt {
        local_var_req_builder =
            local_var_req_builder.query(&[("points_won__lt", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_str) = points_won__lte {
        local_var_req_builder =
            local_var_req_builder.query(&[("points_won__lte", &local_var_str.to_string())]);
    }
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<PredictionsListError> =
...
pub async fn predictions_retrieve(
    configuration: &configuration::Configuration,
    params: PredictionsRetrieveParams,
) -> Result<crate::models::PredictionUsername, Error<PredictionsRetrieveError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<PredictionsRetrieveError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
