...
/// QuestionDetail : Just contains basic data used by all other serializers. Does not include all of the derived data.
...
pub struct QuestionDetail {
    ...
    pub sub_questions: Vec<crate::models::SubQuestionDetail>,
...
impl QuestionDetail {
    ...
    pub fn new(
        ...
        sub_questions: Vec<crate::models::SubQuestionDetail>,
